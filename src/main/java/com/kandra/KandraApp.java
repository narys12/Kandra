...
import com.kandra.config.ApplicationProperties;
import com.kandra.config.DefaultProfileUtil;
...
@EnableZuulProxy
public class KandraApp {

    private static final Logger log = LoggerFactory.getLogger(KandraApp.class);

    private final Environment env;

    public KandraApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(KandraApp.class);
